...
export default function Testimonials() {
    ...
    return(
        <main className="sectionPadding flex flex-row flex-wrap justify-center items-center gap-8">
            ...
            <div className="w-full flex flex-row flex-wrap gap-8 p-12 m-auto">
                {Reviews.map((review) => (
                    <div className="w-[350px] aspect-video bg-slate-200 shadow-lg p-8 flex flex-wrap gap-4">
