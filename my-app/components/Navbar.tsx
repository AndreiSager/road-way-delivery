    ...
    return(
        <nav className="flex flex-row justify-between items-center w-full py-4 px-12">
            ...
            <div className="hidden lg:flex flex-row gap-8 justify-center items-center">
                ...
                <button type="button" className="px-12 py-4 bg-red-500 flex flex-row justify-center items-center gap-2 text-white font-bold"><GiCarWheel size={sizeIcon}/>Drive Now</button>
            </div>
