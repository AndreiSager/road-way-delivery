    ...
    return(
        <main className="sectionPadding">
            <div className="flex flex-row flex-wrap justify-center items-center gap-16">
                ...
                <div className="flex flex-row flex-wrap gap-16 lg:gap-10 justify-center lg:justify-between items-center w-full lg:p-4  bg-slate-200">
                        ...
                        <div key={plan.id} className="rounded-lg bg-white shadow-lg">
                            <div className="w-[350px] h-[230px] flex flex-row p-6 gap-5">
                                <div className="w-2/3 flex flex-col justify-between">
                                    ...
                                    <div>
                                        <button type="button" className="w-full flex-1 p-4 bg-accent-1 text-white font-extrabold text-lg uppercase">{plan.price}$ /day</button>
                                    </div>
                                </div>
